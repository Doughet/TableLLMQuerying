...
class ChatInterface:
    ...
    def __init__(self, db_path: str, api_key: str, model_id: str = "mistral-small", output_dir: Optional[str] = None):
        """
        ...
        Args:
            ...
            output_dir: Directory for saving query results
        """
        ...
        self.result_exporter = ResultExporter(output_dir)
        ...
        if info['tables']:
            ...
            summary.update({
                ...
                'sample_tables': [
                    ...
                    for table in info['tables']  # Show all tables, not just first 3
                ]
            })
    ...
    def execute_and_save(self, 
        ...
        """
        Execute a query and save results to file.
        ...
        Returns:
            Dictionary with query results and export information
        """
        # First, analyze and generate SQL
        sql_query = self.chat(user_query)
        
        if sql_query == "IMPOSSIBLE":
            return {
                'success': False,
        ...
        # Save results
        try:
            filepath = self.result_exporter.export(
                results=results,
                format=format,
                filename=filename,
                query=sql_query
    ...
    def save_last_results(self, 
        ...
        """
        Save previously executed results to file.
        ...
        """
        return self.result_exporter.export(
            results=results,
            format=format,
            filename=filename,
            query=sql_query
    ...
    def get_supported_export_formats(self) -> List[str]:
        ...
        return self.result_exporter.get_supported_formats()